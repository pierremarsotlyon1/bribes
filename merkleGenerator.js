...
describe("MerkleGenerator", function () {
  const users = [
    ...
    { index: 0,address: "0xf69Ca530Cd4849e3d1329FBEC06787a96a3f9A68", amount: 20 },
    { index: 0,address: "0xa8532aAa27E9f7c3a96d754674c99F1E2f824800", amount: 30 },
  ];

  // equal to MerkleDistributor.sol #keccak256(abi.encodePacked(account, amount));
  const elements = users.map((x) =>
    utils.solidityKeccak256(["uint256", "address", "uint256"], [x.address, x.amount])
  );
